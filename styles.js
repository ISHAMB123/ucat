...
.ud {
  ...
  background:var(--ink); color:var(--paper); font-family:Arial,sans-serif;
...
.ud .mono { font-family:Arial,sans-serif; font-variant-numeric:tabular-nums; }
...
.ud-mark b { font-family:Arial,sans-serif; font-weight:800; font-size:19px; letter-spacing:-0.02em; }
.ud-mark span { font-family:Arial,sans-serif; font-size:10px; color:var(--signal); letter-spacing:0.18em; text-transform:uppercase; }
.ud-nav { display:flex; gap:4px; flex-wrap:wrap; }
.ud-nav button { background:transparent; color:var(--mute); font-family:Arial,sans-serif; font-size:11px; letter-spacing:0.09em; text-transform:uppercase; padding:7px 10px; border-radius:2px; position:relative; }
...
.ud-badge { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.12em; text-transform:uppercase; color:var(--mute); border:1px solid var(--line); padding:5px 9px; border-radius:2px; }
.ud-badge.on { color:var(--go); border-color:var(--go); }
.ud-hero { padding:52px 0 40px; border-bottom:1px solid var(--line); }
.ud-eyebrow { font-family:Arial,sans-serif; font-size:11px; letter-spacing:0.16em; text-transform:uppercase; color:var(--signal); margin-bottom:18px; }
.ud-h1 { font-family:Arial,sans-serif; font-weight:800; font-size:clamp(34px,7vw,62px); line-height:0.97; letter-spacing:-0.035em; margin:0 0 18px; max-width:16ch; }
...
.ud-stat b { font-family:Arial,sans-serif; font-size:23px; display:block; letter-spacing:-0.02em; }
.ud-stat span { font-size:10.5px; color:var(--mute); text-transform:uppercase; letter-spacing:0.1em; font-family:Arial,sans-serif; }
.ud-sec { padding:36px 0 6px; display:flex; align-items:baseline; gap:14px; }
.ud-sec h2 { font-family:Arial,sans-serif; font-weight:700; font-size:21px; margin:0; letter-spacing:-0.02em; }
.ud-sec i { flex:1; height:1px; background:var(--line); font-style:normal; }
.ud-sec span { font-family:Arial,sans-serif; font-size:11px; color:var(--mute); }
...
.ud-tag { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.14em; color:var(--signal); }
.ud-card h3 { font-family:Arial,sans-serif; font-weight:700; font-size:16.5px; margin:0; letter-spacing:-0.015em; }
.ud-card p { font-size:12.5px; line-height:1.5; color:var(--mute); margin:0; }
.ud-best { font-family:Arial,sans-serif; font-size:11px; color:var(--go); }
.ud-lock { font-family:Arial,sans-serif; font-size:10px; color:var(--mute); letter-spacing:0.1em; }
...
.ud-config label { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.12em; text-transform:uppercase; color:var(--mute); }
.ud-config .row { display:flex; gap:6px; align-items:center; }
.ud-config .row button { background:transparent; border:1px solid var(--line); color:var(--mute); font-size:12px; padding:7px 12px; border-radius:2px; font-family:Arial,sans-serif; }
...
.ud-config .val { font-family:Arial,sans-serif; font-size:14px; color:var(--paper); min-width:26px; text-align:center; }
...
.ud-sub b { display:block; font-size:14px; font-family:Arial,sans-serif; margin-bottom:3px; }
...
.ud-price h3 { font-family:Arial,sans-serif; font-weight:800; font-size:28px; margin:0 0 6px; letter-spacing:-0.03em; }
...
.ud-code input { background:var(--ink); border:1px solid var(--line); color:var(--paper); padding:10px 12px; border-radius:3px; font-family:Arial,sans-serif; font-size:13px; width:150px; }
...
.ud-nextup h3 { font-family:Arial,sans-serif; font-size:21px; margin:6px 0 4px; letter-spacing:-0.02em; }
...
.ud-weekhead b { font-family:Arial,sans-serif; font-size:15.5px; flex:1; }
.ud-weekhead .wk { font-family:Arial,sans-serif; font-size:10px; color:var(--signal); letter-spacing:0.14em; text-transform:uppercase; flex:none; }
...
.ud-day .n { font-family:Arial,sans-serif; font-size:11px; color:var(--mute); width:38px; flex-shrink:0; }
.ud-day .nm { flex:1; font-size:13.5px; }
.ud-day .meta { font-family:Arial,sans-serif; font-size:10.5px; color:var(--mute); }
...
.ud-trend h3 { font-family:Arial,sans-serif; font-size:15.5px; margin:0; }
.ud-trend .sum { font-family:Arial,sans-serif; font-size:11px; color:var(--mute); }
...
.ud-axis { display:flex; justify-content:space-between; font-family:Arial,sans-serif; font-size:10px; color:var(--mute); margin-top:6px; }
.ud-weak { display:flex; flex-wrap:wrap; gap:6px; margin-top:12px; }
.ud-weak b { font-family:Arial,sans-serif; font-size:11px; background:var(--ink); border:1px solid var(--stop); color:var(--stop); padding:4px 8px; border-radius:2px; font-weight:400; }
...
.ana-h { font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.12em; text-transform:uppercase; color:var(--mute); margin:0 0 12px; }
...
.ud-lcard h4 { font-family:Arial,sans-serif; font-size:15px; margin:0; }
.ud-lcard p { font-size:13px; line-height:1.6; color:var(--body); margin:0; flex:1; }
.ud-lcard button { align-self:flex-start; background:transparent; border:1px solid var(--line); color:var(--signal); font-family:Arial,sans-serif; font-size:11px; padding:6px 11px; border-radius:2px; letter-spacing:0.08em; }
...
.ud-clock { font-family:Arial,sans-serif; font-size:25px; font-weight:700; color:var(--signal); letter-spacing:-0.02em; }
...
.ud-quit { background:transparent; color:var(--mute); font-size:12px; font-family:Arial,sans-serif; }
.ud-quit:hover { color:var(--stop); }
.ud-examflag { font-family:Arial,sans-serif; font-size:10px; color:var(--stop); border:1px solid var(--stop); padding:4px 7px; border-radius:2px; letter-spacing:0.1em; }
...
.ud-panel h4 { font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.14em; text-transform:uppercase; color:#5A6675; margin:0 0 16px; }
.ud-q { font-family:Arial,sans-serif; font-size:clamp(26px,5.5vw,40px); font-weight:700; letter-spacing:-0.03em; margin:0 0 20px; }
...
.ud-input { width:100%; background:#fff; border:1px solid var(--paperline); border-radius:3px; padding:13px; font-family:Arial,sans-serif; font-size:19px; color:#131A22; }
...
.ud-opt b { font-family:Arial,sans-serif; font-size:11px; color:#5A6675; background:#EDEFF2; border-radius:2px; min-width:20px; height:20px; display:flex; align-items:center; justify-content:center; flex-shrink:0; font-weight:500; }
...
.ud-flash { font-family:Arial,sans-serif; font-size:clamp(30px,7vw,48px); font-weight:700; text-align:center; padding:56px 0; letter-spacing:-0.02em; }
...
.ud-graph .bar span { position:absolute; top:-19px; left:0; right:0; text-align:center; font-family:Arial,sans-serif; font-size:11px; color:#333D48; }
.ud-graph-x { display:flex; gap:10px; padding:0 4px; margin-bottom:14px; }
.ud-graph-x span { flex:1; text-align:center; font-family:Arial,sans-serif; font-size:11px; color:#5A6675; }
...
.ud-review h5 { font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.13em; text-transform:uppercase; margin:0 0 8px; color:#5A6675; }
...
.ud-score { font-family:Arial,sans-serif; font-weight:800; font-size:clamp(46px,10vw,88px); letter-spacing:-0.045em; line-height:1; margin:0; }
...
.ud-band b { font-family:Arial,sans-serif; font-size:26px; color:var(--signal); }
...
.ud-row span { font-family:Arial,sans-serif; font-size:10px; color:var(--mute); width:22px; flex-shrink:0; }
.ud-bar { height:14px; border-radius:2px; min-width:3px; }
.ud-row em { font-family:Arial,sans-serif; font-size:10px; color:var(--mute); font-style:normal; }
...
.ud-foot { border-top:1px solid var(--line); padding:20px 0 40px; font-size:11px; color:var(--mute); font-family:Arial,sans-serif; line-height:1.7; }
...
.ud-mrow .sec { font-family:Arial,sans-serif; font-size:10px; color:var(--signal); width:34px; flex-shrink:0; }
.ud-mrow .txt { flex:1; font-size:13px; color:var(--body); line-height:1.4; }
.ud-mrow .ct { font-family:Arial,sans-serif; font-size:11px; color:var(--stop); flex-shrink:0; }
...
.ud-lesson .mod { font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.15em; text-transform:uppercase; color:var(--signal); margin:0 0 6px; }
.ud-lesson h3 { font-family:Arial,sans-serif; font-size:22px; margin:0 0 12px; letter-spacing:-0.02em; }
...
.ud-lopt b { font-family:Arial,sans-serif; font-size:11px; color:var(--mute); border:1px solid var(--line); border-radius:2px; min-width:20px; height:20px; display:flex; align-items:center; justify-content:center; flex-shrink:0; font-weight:500; }
...
.ud-modal h3 { font-family:Arial,sans-serif; font-size:19px; margin:0 0 8px; letter-spacing:-0.02em; }
...
.vue-disp .mflag { font-size:11px; margin-right:auto; width:14px; font-family:Arial,sans-serif; }
.vue-disp .num { margin-left:auto; overflow:hidden; }
.vue-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:5px; }
.vue-key { background:#E8EDF3; border:1px solid #9DB2C8; border-bottom-width:3px; border-radius:3px; padding:9px 0; font-family:Arial,sans-serif; font-size:12.5px; color:#10233A; }
...
.vue-panel h5 { font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.13em; text-transform:uppercase; color:var(--signal); margin:0 0 10px; }
...
.vue-row b { font-family:Arial,sans-serif; font-size:11px; color:var(--paper); background:var(--ink); border:1px solid var(--line); padding:2px 6px; border-radius:2px; min-width:56px; text-align:center; font-weight:500; flex-shrink:0; }
...
.ud-tcard .k { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.15em; text-transform:uppercase; color:var(--signal); }
.ud-tcard b { font-family:Arial,sans-serif; font-size:16px; letter-spacing:-0.015em; }
...
.ud-syl .yn button { border:1px solid var(--paperline); background:#F4F6F9; color:#131A22; font-family:Arial,sans-serif; font-size:11.5px; padding:6px 12px; border-radius:2px; }
...
.ud-gate h2 { font-family:Arial,sans-serif; font-size:clamp(26px,5vw,38px); letter-spacing:-0.03em; margin:10px 0 8px; }
...
.ud-track b { font-family:Arial,sans-serif; font-size:20px; letter-spacing:-0.02em; }
...
.mock-navbtn { background:transparent; border:1px solid var(--line); color:var(--body); font-family:Arial,sans-serif; font-size:12px; padding:8px 14px; border-radius:3px; }
...
.nav-head b { font-family:Arial,sans-serif; font-size:16px; }
...
.nav-row.nav-hd { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; text-transform:uppercase; color:var(--mute); position:sticky; top:0; background:var(--slate); }
...
.ud-reviewgrid .rv { position:relative; width:34px; height:34px; display:flex; align-items:center; justify-content:center; border-radius:3px; font-family:Arial,sans-serif; font-size:12px; text-decoration:none; border:1px solid var(--line); }
...
.ud-charttoggle button { background:transparent; color:var(--mute); font-family:Arial,sans-serif; font-size:10px; text-transform:uppercase; letter-spacing:0.08em; padding:4px 9px; }
.ud-charttoggle button.on { background:var(--signal); color:#131A22; }
.ud-mode { display:flex; gap:6px; align-items:center; }
.ud-mode span { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.12em; text-transform:uppercase; color:var(--mute); margin-right:6px; }
.ud-mode button { background:transparent; border:1px solid var(--line); color:var(--mute); font-size:12px; padding:7px 12px; border-radius:2px; font-family:Arial,sans-serif; }
...
.iv-card h4 { font-family:Arial,sans-serif; font-size:15.5px; margin:0 0 6px; }
...
.iv-practice .qbig { font-family:Arial,sans-serif; font-size:clamp(19px,3.5vw,26px); line-height:1.3; letter-spacing:-0.02em; margin:8px 0 16px; }
...
.iv-clock { font-family:Arial,sans-serif; font-size:34px; font-weight:700; color:var(--signal); }
.iv-clock.answer { color:var(--go); }
@keyframes ivpulse { 0%,100% { opacity:1 } 50% { opacity:.45 } }
.iv-phase { font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.15em; text-transform:uppercase; color:var(--mute); animation:ivpulse 2s infinite; }
...
.uni-form label { display:flex; flex-direction:column; gap:6px; font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; text-transform:uppercase; color:var(--mute); }
.uni-form input, .uni-form select { background:var(--ink); border:1px solid var(--line); color:var(--paper); padding:10px; border-radius:3px; font-size:14px; font-family:Arial,sans-serif; }
...
.uni-row h4 { font-family:Arial,sans-serif; font-size:16px; margin:0; flex:1; }
.uni-chip { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; padding:4px 8px; border-radius:2px; border:1px solid; }
...
.uni-pi span { font-family:Arial,sans-serif; font-size:10.5px; color:var(--mute); }
.gr-wrap { display:flex; flex-wrap:wrap; gap:6px; align-items:center; }
.gr-chip { font-family:Arial,sans-serif; font-size:13px; font-weight:700; width:32px; height:32px; border-radius:3px; border:1px solid var(--line); background:var(--ink); color:var(--paper); }
...
.gr-add button { font-family:Arial,sans-serif; font-size:11px; background:transparent; border:1px dashed var(--line); color:var(--mute); border-radius:3px; padding:6px 8px; }
.gr-add button:hover { color:var(--signal); border-color:var(--signal); }
.uni-mono { font-family:Arial,sans-serif; font-weight:800; font-size:13px; width:34px; height:34px; border-radius:50%; border:1.5px solid; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
.uni-morebtn { margin-top:10px; background:transparent; border:1px solid var(--line); color:var(--signal); font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.1em; padding:7px 12px; border-radius:2px; }
...
.uni-budget label { display:flex; flex-direction:column; gap:5px; font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.1em; text-transform:uppercase; color:var(--mute); }
...
.wp-scaffold b { display:block; font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; color:var(--signal); margin-bottom:3px; }
.wp-scaffold span { font-size:11.5px; color:var(--mute); line-height:1.45; }
.wp-box { min-height:150px; font-size:14px; line-height:1.6; font-family:Arial,sans-serif; background:var(--ink); color:var(--paper); border-color:var(--line); }
...
.wp-result .band b { font-family:Arial,sans-serif; font-size:24px; letter-spacing:-0.02em; }
...
.wp-score10 b { font-family:Arial,sans-serif; font-size:40px; letter-spacing:-0.03em; }
...
.cd-num b { font-family:Arial,sans-serif; font-size:34px; line-height:1; letter-spacing:-0.03em; }
.cd-num span { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.12em; text-transform:uppercase; color:var(--mute); margin-top:4px; }
.cd-strip.set > div:first-child { display:flex; flex-direction:column; gap:3px; flex:1; }
.cd-strip .k { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.14em; text-transform:uppercase; color:var(--signal); }
.cd-strip.set b { font-family:Arial,sans-serif; font-size:17px; letter-spacing:-0.02em; }
.cd-strip .d { font-size:12px; color:var(--mute); }
.cd-in { display:flex; gap:8px; align-items:center; }
.cd-in input { background:var(--ink); border:1px solid var(--line); color:var(--paper); padding:9px 11px; border-radius:3px; font-size:13px; font-family:Arial,sans-serif; }
...
.vr-diag .k { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.14em; text-transform:uppercase; color:var(--signal); }
.vr-diag h3 { font-family:Arial,sans-serif; font-size:19px; margin:6px 0 8px; letter-spacing:-0.02em; }
...
.iv-warn .ic { font-family:Arial,sans-serif; font-weight:700; color:#131A22; background:var(--signal); width:20px; height:20px; border-radius:50%; display:flex; align-items:center; justify-content:center; flex-shrink:0; font-size:12px; }
...
.iv-unipick label { display:flex; flex-direction:column; gap:7px; font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; text-transform:uppercase; color:var(--mute); }
.iv-unipick select { background:var(--ink); border:1px solid var(--line); color:var(--paper); padding:10px; border-radius:3px; font-size:14px; font-family:Arial,sans-serif; max-width:420px; }
...
.iv-unibox .chips span { font-family:Arial,sans-serif; font-size:10.5px; border:1px solid var(--signal); color:var(--signal); padding:4px 8px; border-radius:2px; }
...
.wp-live { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.14em; text-transform:uppercase; color:var(--stop); animation:wplive 1.2s infinite; }
.wp-head { display:flex; align-items:flex-end; justify-content:space-between; gap:14px; margin-bottom:14px; flex-wrap:wrap; }
.wp-src { display:flex; flex-direction:column; gap:7px; font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; text-transform:uppercase; color:var(--mute); flex:1; min-width:220px; }
.wp-src select { background:var(--ink); border:1px solid var(--line); color:var(--paper); padding:10px; border-radius:3px; font-size:14px; font-family:Arial,sans-serif; max-width:420px; }
...
.auth-card h2 { font-family:Arial,sans-serif; font-size:26px; letter-spacing:-0.03em; margin:8px 0 6px; text-align:center; }
.auth-card .sub { color:var(--mute); font-size:13px; line-height:1.55; margin:0 0 20px; text-align:center; }
.auth-f { display:flex; flex-direction:column; gap:6px; font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; text-transform:uppercase; color:var(--mute); margin-bottom:14px; }
.auth-f input { background:var(--ink); border:1px solid var(--line); color:var(--paper); padding:12px; border-radius:3px; font-size:14px; font-family:Arial,sans-serif; width:100%; }
.auth-f input:focus { border-color:var(--signal); outline:none; }
.pwwrap { position:relative; display:block; }
.pweye { position:absolute; right:8px; top:50%; transform:translateY(-50%); background:transparent; color:var(--mute); font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; padding:4px 6px; }
...
.pwbar span { font-family:Arial,sans-serif; font-size:10px; color:var(--mute); }
...
.bill-card .tag { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.14em; text-transform:uppercase; color:var(--mute); }
.bill-card .tag.on { color:var(--signal); }
.bill-card .price { margin:10px 0 2px; display:flex; align-items:baseline; gap:8px; }
.bill-card .price b { font-family:Arial,sans-serif; font-size:42px; letter-spacing:-0.04em; }
...
.bill-code input { flex:1; background:var(--ink); border:1px solid var(--line); color:var(--paper); padding:10px; border-radius:3px; font-family:Arial,sans-serif; font-size:13px; min-width:0; }
...
.bill-live h3 { font-family:Arial,sans-serif; font-size:19px; margin:2px 0 6px; }
...
.lk-pill b { color:var(--signal); font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.1em; }
...
.uf-head h3 { font-family:Arial,sans-serif; font-size:20px; margin:0 0 4px; letter-spacing:-0.02em; }
.uf-style { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.12em; text-transform:uppercase; padding:3px 8px; border-radius:2px; border:1px solid; }
...
.uf-grid b { display:block; font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.12em; text-transform:uppercase; color:var(--signal); margin-bottom:5px; }
...
.tlab { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.14em; text-transform:uppercase; color:var(--mute); }
.tdone { font-size:12.5px; color:var(--go); }
.wp-hl { border-top:1px solid var(--line); margin-top:14px; padding-top:13px; }
.hh { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.14em; text-transform:uppercase; color:var(--signal); margin:0 0 9px; }
.hkey { display:flex; gap:8px; margin-bottom:10px; }
.hkey span { font-size:10.5px; font-family:Arial,sans-serif; padding:3px 8px; border-radius:2px; }
...
.ps-sec h3 { font-family:Arial,sans-serif; font-size:18px; margin:0 0 8px; letter-spacing:-0.02em; }
...
.ps-tabs button { background:transparent; border:1px solid var(--line); color:var(--mute); font-family:Arial,sans-serif; font-size:11px; letter-spacing:0.06em; padding:9px 14px; border-radius:2px; transition:all .15s; }
...
.dchip button { background:transparent; color:var(--mute); font-size:12px; padding:7px 11px; font-family:Arial,sans-serif; }
...
.ps-head .num { width:24px; height:24px; border-radius:50%; background:var(--signal); color:#131A22; display:flex; align-items:center; justify-content:center; font-family:Arial,sans-serif; font-size:12px; font-weight:700; flex-shrink:0; }
.ps-head .ttl { flex:1; font-family:Arial,sans-serif; font-size:15.5px; color:var(--paper); letter-spacing:-0.01em; }
...
.ps-steps b { display:block; font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.1em; color:var(--signal); margin-bottom:4px; text-transform:uppercase; }
...
.ps-tips .th { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.14em; text-transform:uppercase; color:var(--signal); margin:0 0 9px; }
...
.ps-frames button { background:transparent; border:1px solid var(--line); color:var(--mute); font-family:Arial,sans-serif; font-size:11px; padding:8px 13px; border-radius:2px; }
...
.rsec h4 { display:flex; align-items:center; gap:9px; font-family:Arial,sans-serif; font-size:15px; margin:0 0 10px; }
.rsec .num { width:22px; height:22px; border-radius:50%; background:var(--signal); color:#131A22; display:flex; align-items:center; justify-content:center; font-size:11px; font-family:Arial,sans-serif; font-weight:700; }
...
.gscore b { font-family:Arial,sans-serif; font-size:40px; letter-spacing:-0.03em; }
...
.gflag .gh span { font-family:Arial,sans-serif; font-size:11px; color:var(--mute); }
...
.au-bands .bh { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.14em; text-transform:uppercase; color:var(--signal); margin:0 0 10px; }
...
.pv-sec h4 { display:flex; align-items:center; gap:9px; font-family:Arial,sans-serif; font-size:15px; color:#131A22; margin:0 0 10px; }
.pv-sec .num { width:21px; height:21px; border-radius:50%; background:#131A22; color:#fff; display:flex; align-items:center; justify-content:center; font-size:11px; font-family:Arial,sans-serif; }
...
.tour-card h3 { font-family:Arial,sans-serif; font-size:21px; letter-spacing:-0.02em; margin:8px 0 8px; }
...
.ps-hintbar button { background:transparent; border:1px solid var(--line); color:var(--mute); font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.08em; padding:7px 12px; border-radius:2px; }
...
.intl-box .ih { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.14em; text-transform:uppercase; color:var(--signal); margin:0 0 12px; }
...
.intl-grid b { display:block; font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.1em; text-transform:uppercase; color:var(--signal); margin-bottom:5px; }
...
.facts-head .k { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.14em; text-transform:uppercase; color:var(--signal); flex-shrink:0; }
.facts-head .t { flex:1; font-family:Arial,sans-serif; font-size:15px; color:var(--paper); }
...
.res-weak .k { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.12em; text-transform:uppercase; color:var(--signal); }
...
.score-chart .sc-axis { font-family:Arial,sans-serif; font-size:9px; fill:var(--mute); }
...
.streak-stat b { font-family:Arial,sans-serif; font-size:24px; font-weight:700; color:var(--ink); line-height:1; display:flex; align-items:center; gap:6px; }
...
.ud-side-nav button { display:flex; align-items:center; gap:12px; width:100%; text-align:left; background:transparent; color:var(--body); font-family:Arial,sans-serif; font-size:13.5px; font-weight:500; padding:9px 11px; border-radius:8px; position:relative; transition:background .15s, color .15s; }
...
.learn-title { font-family:Arial,sans-serif; font-weight:700; font-size:18px; color:var(--paper); letter-spacing:-.01em; }
...
.learn-meta { display:flex; justify-content:space-between; font-family:Arial,sans-serif; font-size:11px; letter-spacing:.03em; text-transform:uppercase; color:var(--mute); }
...
.learn-count { font-family:Arial,sans-serif; font-size:11px; letter-spacing:.03em; text-transform:uppercase; color:var(--mute); }
...
.tech-num { flex:none; font-family:Arial,sans-serif; font-size:13px; font-weight:600; color:var(--signal); line-height:1.4; min-width:20px; }
.tech-note .tech-num { color:var(--mute); }
.tech-body { flex:1; min-width:0; }
.tech-body h4 { margin:0 0 5px; font-family:Arial,sans-serif; font-size:15.5px; font-weight:700; color:var(--paper); letter-spacing:-.01em; }
.tech-body p { margin:0; font-size:13.5px; line-height:1.62; color:var(--body); }
.tech-drill { margin-top:11px; padding:6px 12px; background:none; border:1px solid var(--line); border-radius:4px; color:var(--signal); font-family:Arial,sans-serif; font-size:11px; letter-spacing:.04em; text-transform:uppercase; cursor:pointer; transition:border-color .15s, background .15s; }
...
.price .was, .bill-card .price .was { font-family:Arial,sans-serif; font-size:15px; color:var(--mute); text-decoration:line-through; margin-left:10px; -webkit-text-decoration:line-through; }
...
.mock-official .mo-head h3 { margin:0 0 6px; font-family:Arial,sans-serif; font-size:17px; letter-spacing:-0.01em; }
...
.plan-build h3 { margin:0 0 12px; font-family:Arial,sans-serif; font-size:15.5px; }
...
.cust-start .meta { font-family:Arial,sans-serif; font-size:10.5px; color:var(--mute); flex:none; }
...
.pl-datebar.set b { display:block; font-family:Arial,sans-serif; font-size:15px; }
...
.pl-ddate { flex:1; font-family:Arial,sans-serif; font-size:12px; color:var(--mute); }
...
.pl-stat b { display:block; font-family:Arial,sans-serif; font-size:21px; letter-spacing:-0.02em; }
...
.pl-gen h3 { margin:0 0 5px; font-family:Arial,sans-serif; font-size:15.5px; }
...
.pl-ghead { display:flex; justify-content:space-between; align-items:center; padding:9px 15px; background:var(--slate); font-family:Arial,sans-serif; font-size:11px; letter-spacing:0.06em; text-transform:uppercase; color:var(--mute); }
...
.pl-sec { font-family:Arial,sans-serif; font-size:9.5px; font-weight:700; padding:2px 5px; border-radius:3px; letter-spacing:0.05em; }
...
.pl-l2 { display:flex; gap:10px; flex-wrap:wrap; margin-top:3px; font-family:Arial,sans-serif; font-size:10.5px; color:var(--mute); }
.pl-l2 .pl-over { color:var(--stop); }
.pl-l2 .pl-note { font-family:Arial,sans-serif; font-style:italic; color:var(--body); }
...
.sconv-head h3 { margin:0 0 5px; font-family:Arial,sans-serif; font-size:17px; letter-spacing:-0.01em; }
...
.sconv-t { font-family:Arial,sans-serif; font-size:11px; letter-spacing:0.06em; text-transform:uppercase; color:var(--signal); margin-bottom:12px; }
.sconv-grid { display:grid; grid-template-columns:1fr 68px 68px 52px; gap:8px 8px; align-items:center; }
.sconv-grid .sc-h { font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.05em; text-transform:uppercase; color:var(--mute); }
.sconv-grid .sc-name { font-size:12.5px; }
.sconv-grid input { width:100%; padding:7px 8px; text-align:center; }
.sconv-grid .sc-out { font-family:Arial,sans-serif; font-size:15px; font-weight:600; color:var(--signal); text-align:center; }
...
.sconv-total b { font-family:Arial,sans-serif; font-size:20px; letter-spacing:-0.02em; }
...
.sconv-old b { font-family:Arial,sans-serif; font-size:20px; letter-spacing:-0.02em; }
...
/* ---- Mock leaderboard ---- */
.lb-ava { display:inline-flex; align-items:center; justify-content:center; border-radius:50%; color:#fff; font-family:Arial,sans-serif; font-weight:700; flex:none; }
...
.lb-stand-mid b { display:block; font-family:Arial,sans-serif; font-size:16px; letter-spacing:-0.01em; }
...
.lb-pod-base { width:100%; margin-top:8px; border-radius:5px 5px 0 0; display:flex; align-items:flex-start; justify-content:center; color:#12161b; font-family:Arial,sans-serif; font-weight:800; font-size:20px; padding-top:6px; opacity:0.92; }
...
.lb-name em { font-style:normal; margin-left:7px; font-family:Arial,sans-serif; font-size:9.5px; letter-spacing:0.06em; text-transform:uppercase; color:#12161b; background:var(--signal); padding:1px 5px; border-radius:3px; }
...
.lb-bins-x { display:flex; justify-content:space-between; margin-top:5px; font-family:Arial,sans-serif; font-size:9.5px; color:var(--mute); }
...
.res-badge { font-family:Arial,sans-serif; font-size:12px; letter-spacing:0.03em; padding:6px 13px; border-radius:20px; border:1px solid var(--line); }
...
.ok-gbody b { display:block; font-family:Arial,sans-serif; font-size:17px; }
...
.ok-eyebrow { font-family:Arial,sans-serif; font-size:10.5px; letter-spacing:0.08em; text-transform:uppercase; color:var(--mute); }
.ok-band { display:flex; align-items:baseline; gap:8px; margin:8px 0 10px; }
.ok-band b { font-family:Arial,sans-serif; font-size:30px; letter-spacing:-0.03em; color:var(--signal); }
.ok-band span { font-size:12px; color:var(--mute); }
.ok-secs { display:flex; flex-wrap:wrap; gap:7px; }
.ok-secs span { font-family:Arial,sans-serif; font-size:11px; padding:3px 8px; border-radius:4px; background:var(--slate); border:1px solid var(--line); }
...
.ok-empty b { display:block; font-family:Arial,sans-serif; font-size:15px; margin-bottom:5px; }
...
.pace-panel .k { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.12em; text-transform:uppercase; color:var(--signal); }
...
.pace-chip { font-family:Arial,sans-serif; font-size:10px; letter-spacing:0.05em; text-transform:uppercase; padding:4px 8px; border-radius:3px; border:1px solid; white-space:nowrap; }
...
.mmi-type { font-family:Arial,sans-serif; font-size:9.5px; font-weight:700; letter-spacing:0.08em; text-transform:uppercase; color:var(--signal); border:1px solid color-mix(in srgb, var(--signal) 40%, var(--line)); padding:3px 7px; border-radius:4px; flex:none; }
...
.mmi-answer textarea { width:100%; background:var(--ink); border:1px solid var(--line); color:var(--paper); border-radius:5px; padding:11px 12px; font-family:Arial,sans-serif; font-size:14px; line-height:1.5; resize:vertical; }

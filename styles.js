...
.ud-eyebrow { font-family:'Inter',sans-serif; font-size:11px; letter-spacing:0.16em; text-transform:uppercase; color:var(--signal); margin-bottom:18px; }
...
.ud-stat b { font-family:'Inter',sans-serif; font-size:23px; display:block; letter-spacing:-0.02em; }
.ud-stat span { font-size:10.5px; color:var(--mute); text-transform:uppercase; letter-spacing:0.1em; font-family:'Inter',sans-serif; }
...
.ud-tag { font-family:'Inter',sans-serif; font-size:10px; letter-spacing:0.14em; color:var(--signal); }
...
.ud-best { font-family:'Inter',sans-serif; font-size:11px; color:var(--go); }
...
.ud-config .row button { background:transparent; border:1px solid var(--line); color:var(--mute); font-size:12px; padding:7px 12px; border-radius:2px; font-family:'Inter',sans-serif; }
...
.ud-mrow .sec { font-family:'Inter',sans-serif; font-size:10px; color:var(--signal); width:34px; flex-shrink:0; }
.ud-mrow .txt { flex:1; font-size:13px; color:var(--body); line-height:1.4; }
.ud-mrow .ct { font-family:'Inter',sans-serif; font-size:11px; color:var(--stop); flex-shrink:0; }
...
.streak-stat b { font-family:'Inter',sans-serif; font-size:24px; font-weight:700; color:var(--ink); line-height:1; display:flex; align-items:center; gap:6px; }
